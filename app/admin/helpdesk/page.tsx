          ...
          <section className="space-y-6">
            ...
            {params.deleted ? (
              <div className="rounded-md border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-bold text-emerald-800">
                Deleted {params.deleted} support{" "}
                {params.deleted === "1" ? "ticket" : "tickets"}.
              </div>
            ) : null}

            {params.error === "missing_delete" ? (
              <div className="rounded-md border border-amber-200 bg-amber-50 px-4 py-3 text-sm font-bold text-amber-900">
                Select at least one ticket before using bulk delete.
              </div>
            ) : null}
              ...
              <div className="flex flex-col gap-3 border-b border-slate-200 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Select multiple tickets to remove them in one go.
                  </p>
                </div>
                <form
                  id="bulk-delete-tickets"
                  action={deleteAdminTicketsAction}
                  className="hidden"
                />
                <button
                  type="submit"
                  form="bulk-delete-tickets"
                  className="inline-flex items-center justify-center gap-2 rounded-md border border-rose-200 bg-rose-50 px-4 py-2 text-sm font-bold text-rose-700 transition hover:bg-rose-100"
                >
                    ...
                    >
                      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                        <div className="flex min-w-0 gap-3">
                          ...
                          <div className="min-w-0">
                            ...
                            <Link
                              ...
                              className="mt-3 block text-lg font-extrabold tracking-normal text-slate-950 transition hover:text-[#168b43] hover:underline"
                            >
                              {ticket.subject}
                            </Link>
                        ...
                        <div className="flex flex-wrap items-center gap-3 text-sm text-slate-500 lg:justify-end">
                          ...
                          <form action={deleteAdminTicketsAction}>
                            <input
                              type="hidden"
                              name="ticket_id"
                              value={ticket.id}
                            />
                            <button className="inline-flex items-center gap-1 rounded-md border border-rose-200 bg-white px-3 py-2 text-xs font-bold text-rose-700 transition hover:bg-rose-50">
