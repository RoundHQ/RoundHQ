      ...
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-3xl flex-col justify-between">
        ...
        <section className="py-16">
          ...
          <h1 className="mt-4 max-w-2xl text-4xl font-black tracking-tight md:text-5xl">
            Thanks, your invoice payment has been submitted.
          </h1>
          <p className="mt-5 max-w-xl text-base leading-7 text-white/75">
            Stripe has processed the payment and RoundHQ will update the invoice
            status once the payment confirmation reaches the workspace.
          </p>
        </section>
